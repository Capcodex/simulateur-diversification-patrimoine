...
function estimerPartArt(patrimoine: number, profil: ProfilInvestisseur, objectif: Objectif): string {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const patrimoine = parseFloat((document.getElementById("patrimoine") as HTMLInputElement).value);
